      ...
      <div className="bg-slate-800 border border-slate-700 rounded-3xl p-6 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-xl font-black text-white">Hierarchical Return & Replacement Policies</h1>
          </div>
        </div>
        <span className="text-xs px-3 py-1 bg-blue-500/20 text-blue-300 font-bold rounded-full border border-blue-500/30">
          7-Day Window Default
        </span>
      </div>

      <div className="bg-slate-800 border border-slate-700 rounded-3xl p-6 text-xs text-slate-400">
        Configure return windows, replacement eligibility, and proof requirements by Category, Product, and Vendor.
      </div>
    </div>
  );
}
